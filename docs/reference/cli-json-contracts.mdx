...
description: Stable JSON schemas for ongoingai report, debug, and diagnostics scripting integrations.
related:
  title: Next steps
...
- This page documents `report.v1`, `debug-chain.v1`, and
  `trace-pipeline-diagnostics.v1`.
...
| `llm_response_content` | object | no |
